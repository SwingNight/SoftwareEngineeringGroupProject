    ...
    */
    ...
    function renderInnerContent$4(props) {
        var navLinkAttrs = props.navLinkData // is there a type for this?
            ...
            : {};
        return (createElement(Fragment, null,
            props.text && (createElement("p", __assign({ className: "fc-list-day-text" }, navLinkAttrs), props.text)),
            props.sideText && (createElement("p", __assign({ className: "fc-list-day-side-text" }, navLinkAttrs), props.sideText))));
    }
